...
class Constants
{
  static const carmine = Color(0xffA30015);
  static const babyPowder = Color(0xffF4F4ED);
  static const lightYellow = Color(0xffFDFCDC);
  static const earthYellow = Color(0xffDDA15E);
